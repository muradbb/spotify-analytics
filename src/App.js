...
function UserTrends(props)
{
    ...
    function RelatedArtists(props)
    {
        ...
        return ( <
            ...
            Enter names of one of your favourite artists to get related artists to them <
            /h2> <
            form onSubmit = {
                handleSubmit
            }
    ...
    function PlaylistCreator(props)
    {
        ...
        return ( <
            ...
            <
            h2 >
            In this section you can create playlists with your top 50 tracks from different time periods <
            /h2> <
    ...
    function RecentlyPlayed(props)
    {
        ...
        function songBox(song)
        {
            return ( <
                ...
                {
                    wordCutter(song.name)
                } < /li> <
                li style = {
                    liStyle
                } > Album:
                {
                    wordCutter(song.albumName)
                } < /li> <
                li style = {
                    liStyle
                } > Artist:
                {
                    wordCutter(song.artist)
                } < /li> <
                li style = {
                    liStyle
                } > Duration:
                {
                    toHumanTime(song.duration)
                } < /li> <
                li style = {
                    liStyle
                } > Played at:
                {
                    toHumanDate(song.playedAt)
                } < /li> <
                /ul> <
                /div> <
                /div>
        ...
        return recentSongs ? ( <
            ...
            Ever listened to a song on spotify then forgot the name ? Worry not!Just enter the number of recently played songs you would like to see. <
            /p> <
            form onSubmit = {
                handleSubmit
            }
    ...
    function TopArtistPlaylistCreator(props)
    {
        ...
        return ( <
            ...
            <
            h3 >
            By pressing create you can make a playlist from your top
            {
                "artists'"
            }
            {
        ...
        return ( <
            div >
            {
                serverData ? ( <
                    ...
                    TopArtistPlaylistCreator artists = {
                    ...
                    <
                    h2 > Your favourite artists
                    for the last 6 months < /h2>
                    {
                    ...
                    <
                    h2 >
                    These are a list of songs that were your favourite over a certian period of time <
                    /h2> <
                    Collapsible trigger = "Your all time favourite tracks" >
                    <
                    FavTracks tracks = {
                        serverData.user.favTracks.longTerm
                    }
                    /> <
                    /Collapsible> <
                    ...
                    <
                    FavTracks tracks = {
                        serverData.user.favTracks.mediumTerm
                    }
                    /> <
                    /Collapsible> <
                    ...
                    <
                    FavTracks tracks = {
                        serverData.user.favTracks.shortTerm
                    }
                    /> <
                    /Collapsible> <
                    /div> <
                    ...
                    RelatedArtists artists = {
                        serverData.user.favArtists
                    }
                    userID = {
                        serverData.user.id
                    }
                    /> <
                    AudioFeatureTrend tracks = {
                        serverData.user.favTracks.longTerm
                    }
                    /> <
                    ...
                    h3 > This app is a tool
                    for analyzing you spotify data and showing you useful insights < /h3> <
                    /div> <
                    /div>
                )
